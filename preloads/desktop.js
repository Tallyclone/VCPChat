...
function createCatalog(ops) {
    return {
        ...
        // NativeFs APIs
        nativeFsRegisterMount: query((args) => ops.invoke('nativeFs:registerMount', args)),
        ...
        onNativeFsChange: subscription(ops.subscribe('nativeFs:change', (_event, data) => data)),
        ...
        nativeFsCopyToClipboard: query((args) => ops.invoke('nativeFs:copyToClipboard', args)),
        nativeFsCutToClipboard: query((args) => ops.invoke('nativeFs:cutToClipboard', args)),
        nativeFsPasteFromClipboard: query((args) => ops.invoke('nativeFs:pasteFromClipboard', args)),
        nativeFsUnwatch: query((args) => ops.invoke('nativeFs:unwatch', args)),
        nativeFsRequestOperations: query((args) => ops.invoke('nativeFs:requestOperations', args)),
