...
(function () {
  ...
  const desktopState = {
    ...
    desktopVersion: 1, // 桌面总版本（任一 widget 增删改/布局变化时递增）
    // Dock 状态
    dock: {
  ...
  function initDomRefs() {
    ...
    domRefs.statusIndicator = document.getElementById(
      "desktop-status-indicator"
    );
    domRefs.statusDot = domRefs.statusIndicator?.querySelector(
      ".desktop-status-dot"
    );
    domRefs.statusText = domRefs.statusIndicator?.querySelector(
      ".desktop-status-text"
    );
  }
