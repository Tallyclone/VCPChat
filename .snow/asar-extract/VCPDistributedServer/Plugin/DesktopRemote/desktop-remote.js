...
process.stdin.on("end", () => {
  try {
    ...
    if (!command) {
      throw new Error(
        "The 'command' parameter is required. Valid commands: 'SetWallpaper', 'QueryDesktop', 'QueryDock', 'ViewWidgetSource', 'CreateWidget', 'SetStyleAutomation', 'GetStyleAutomationStatus', 'NativeFileMountAction', 'QueryNativeFileMounts'."
      );
    }
    ...
    if (
      ...
      throw new Error(
        `Unknown command: '${command}'. Valid commands: 'SetWallpaper', 'QueryDesktop', 'QueryDock', 'ViewWidgetSource', 'CreateWidget', 'SetStyleAutomation', 'GetStyleAutomationStatus', 'NativeFileMountAction', 'QueryNativeFileMounts'.`
      );
    }
  } catch (error) {
