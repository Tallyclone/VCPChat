...
(function () {
  ...
  function cleanupTrackedStore(store) {
    ...
    if (Array.isArray(store.prototypeConstructorDescriptors)) {
      store.prototypeConstructorDescriptors.splice(0).forEach((item) => {
        try {
          if (item.descriptor) {
            item.realObject.defineProperty(
              item.proto,
              "constructor",
              item.descriptor
            );
          } else {
            delete item.proto.constructor;
          }
        } catch (error) {}
      });
    }
  ...
  function buildSandboxCode(runtimeId, userCode) {
    ...
    return `(function(_realDoc, _realWindow) {
      ...
      var _blockedGlobals = {
        ...
        electronAPI: true,
        VCPDesktop: true,
        __vcpWidgetRuntimeApis: true,
        require: true,
        process: true,
        module: true,
        exports: true,
      };
      var _prototypeConstructors = [
        _realWindow.Object && _realWindow.Object.prototype,
        _realWindow.Array && _realWindow.Array.prototype,
        _realWindow.Function && _realWindow.Function.prototype,
        _realWindow.String && _realWindow.String.prototype,
        _realWindow.Number && _realWindow.Number.prototype,
        _realWindow.Boolean && _realWindow.Boolean.prototype,
        _realWindow.RegExp && _realWindow.RegExp.prototype,
        _realWindow.Date && _realWindow.Date.prototype,
        _realWindow.Error && _realWindow.Error.prototype,
        _realWindow.TypeError && _realWindow.TypeError.prototype,
        _realWindow.Promise && _realWindow.Promise.prototype,
        _realWindow.Map && _realWindow.Map.prototype,
        _realWindow.Set && _realWindow.Set.prototype,
        _realWindow.WeakMap && _realWindow.WeakMap.prototype,
        _realWindow.WeakSet && _realWindow.WeakSet.prototype,
      ].filter(Boolean);
      var _lockPrototypeConstructors = function() {
        var descriptors = [];
        _prototypeConstructors.forEach(function(proto) {
          var descriptor = _realWindow.Object.getOwnPropertyDescriptor(proto, 'constructor');
          descriptors.push({ proto: proto, descriptor: descriptor });
          try {
            _realWindow.Object.defineProperty(proto, 'constructor', {
              configurable: true,
              enumerable: false,
              writable: true,
              value: undefined,
      ...
      var _restorePrototypeConstructors = function(descriptors) {
        descriptors.forEach(function(item) {
          try {
            if (item.descriptor) {
              _realWindow.Object.defineProperty(item.proto, 'constructor', item.descriptor);
            } else {
              delete item.proto.constructor;
            }
          } catch (error) {}
      ...
      var _withPrototypeLockdown = function(fn, thisArg, args) {
        var descriptors = _lockPrototypeConstructors();
        try {
          return fn.apply(thisArg, args || []);
        } finally {
          _restorePrototypeConstructors(descriptors);
        }
      };
      var _wrap = function(fn) {
        return function() {
          return _withPrototypeLockdown(fn, this, arguments);
        };
      };
      ...
      var window = new Proxy({}, {
        get: function(target, prop) {
          ...
          if (_blockedGlobals[prop]) return undefined;
          ...
          if (['marked', 'hljs', 'anime', 'THREE', 'morphdom', 'CSS', 'URL', 'URLSearchParams', 'Blob', 'File', 'FileReader', 'FormData', 'Headers', 'Request', 'Response', 'fetch', 'console', 'Promise', 'Map', 'Set', 'WeakMap', 'WeakSet', 'Array', 'Object', 'String', 'Number', 'Boolean', 'Date', 'Math', 'JSON', 'RegExp', 'Error', 'TypeError', 'parseInt', 'parseFloat', 'isNaN', 'isFinite', 'encodeURIComponent', 'decodeURIComponent'].includes(prop)) {
            var val = _realWindow[prop];
            return typeof val === 'function' ? val.bind(_realWindow) : val;
          }
          return target[prop];
        },
        ...
        has: function(target, prop) {
          if (_blockedGlobals[prop]) return false;
      ...
      _withPrototypeLockdown(function() {
        (function(window, document, nfm, vcpAPI, marked, hljs, anime, THREE, morphdom, widgetId, setInterval, clearInterval, setTimeout, clearTimeout, requestAnimationFrame, cancelAnimationFrame) {
          'use strict';
          var desktopAPI = undefined;
          var electronAPI = undefined;
          var VCPDesktop = undefined;
          var __vcpWidgetRuntimeApis = undefined;
          ...
          var WeakSet = undefined;
          var Date = undefined;
          var RegExp = undefined;
          var Error = undefined;
          var TypeError = undefined;
          ${userCode}
        })(window, document, nfm, vcpAPI, marked, hljs, anime, THREE, morphdom, widgetId, setInterval, clearInterval, setTimeout, clearTimeout, requestAnimationFrame, cancelAnimationFrame);
      }, null, []);
